...
@implementation CZWTextMessage

+(instancetype)messageWithContent:(NSString *)content {
    CZWTextMessage *msg = [[CZWTextMessage alloc] init];
    if (msg) {
        msg.content = content;
    }
...
#define KEY_TXTMSG_DICTIONARY @"dictionary"
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        self.dictionary = [aDecoder decodeObjectForKey:KEY_TXTMSG_DICTIONARY];
    }
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:self.dictionary forKey:KEY_TXTMSG_DICTIONARY];
}
...
-(NSData *)encode {
    ...
    if (self.dictionary) {
        [dataDict setObject:self.dictionary forKey:@"dictionary"];
    }
